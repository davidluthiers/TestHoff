    ...
    'jquerymobile'
        ...
        viciousView = Backbone.View.extend({
            ...
            render: function(id, historycollection){
				...
				viciousN1 = "  <div data-role='content'>    <div class='hojacuaderno'>    <div class='headerhojacuaderno transfer' data-role='header'>        <h3>         <%= dic_vicious_header %>        </h3>       </div>     <div data-role='content'>      <div data-controltype='textblock'>       <p class='primerPcuaderno'>        <span > 	   <%= dic_vicious_p1N_text1 %>         </span>       </p>      </div>      <div id='checkboxes1' data-role='fieldcontain' data-controltype='checkboxes' class='donotshowagain'>       <fieldset data-role='controlgroup' data-type='vertical'>        <input id='checkbox1' name='' data-theme='b' type='checkbox' />        <label id='checkbox' for='checkbox1'>         <%= dic_donotshow %>        </label>       </fieldset>      </div>     </div>    </div>   </div>   <div data-theme='a' data-role='footer' data-position='fixed' data-tap-toggle='false'>         <a class='botonstart' data-role='button' data-transition='none' href='#vicious4'>     <%= dic_next %>    </a>     </div>";
				vicious0 = "	<div data-role='content'>    <div class='hojacuaderno viciouspage'>       <div class='headerhojacuaderno transfer' data-role='header'>        <h2>         <%= dic_vicious_header %>        </h2>       </div>    <div data-role='content'>     <div data-role='fieldcontain' data-controltype='textinput'>      <label for='coreissue'>       <%= dic_vicious_p0_text1 %>      </label>      <input name='' id='coreissue' placeholder='' value='' type='text' /></div> 	 <div data-role='fieldcontain' data-controltype='textinput'>      <label for='corebelieve'>       <%= dic_vicious_p0_text2 %>      </label>      <input name='' id='corebelieve' placeholder='' value='' type='text' /></div>     <label for='corebelieve'>       <%= dic_vicious_p0_text3 %>      </label>     <div data-controltype='htmlblock'>      <ul id='listfeeders' class='listfeeders' data-role='listview' data-split-icon='delete' data-split-theme='d' data-inset='true'>      </ul>     </div>     <div id='enterfeeder' data-role='fieldcontain' class='noborder' data-controltype='textinput'>      <input name='' id='actualfeeder' value='' type='text' /></div>     <a id='addfeeder' class='addfeeder colorverde' data-role='button' data-transition='none' data-icon='plus' data-iconpos='right'>      <%= dic_vicious_p0_text4 %>     </a> 	<a id='keyspace' style='display:none;' data-role='button' data-transition='none'>Start</a>    </div>   </div>   </div>    <div data-theme='a' data-role='footer' data-position='fixed' data-tap-toggle='false'>         <a class='botonprev' data-role='button' data-transition='none' href='#vicious0' data-icon='arrow-l'>     <%= dic_prev %>    </a>    <a class='addfeeder botonnext' data-role='button' data-transition='none' href='#vicious1' data-icon='arrow-r' data-iconpos='right'>     <%= dic_next %>    </a>     </div>";
				vicious1 = "<div data-role='content'>    <div class='hojacuaderno'>       <div class='headerhojacuaderno transfer' data-role='header'>        <h2>         <%= dic_vicious_header %>        </h2>       </div> 	  <div data-role='content'>          <canvas id='myCanvas'></canvas>     </div>    </div>    </div>   <div data-theme='a' data-role='footer' data-position='fixed' data-tap-toggle='false'>         <a class='botonprev' data-role='button' data-transition='none' href='#vicious4' data-icon='arrow-l'>     <%= dic_prev %>    </a>    <a class='botonnext' data-role='button' data-transition='none' href='#vicious2' data-icon='arrow-r' data-iconpos='right'>     <%= dic_next %>    </a>     </div>";
				vicious2 = "<div data-role='content'>    <div class='hojacuaderno'>       <div class='headerhojacuaderno transfer' data-role='header'>        <h2>         <%= dic_vicious_header %>        </h2>       </div> 	  <div style='text-align: center; margin-top:5%;'>  		<label class='victextocentrado'> <%= dic_vicious_p2_text1 %> </label> 	  </div> <ul id='feederexitlist' data-role='listview' data-inset='true'></ul>   </div>   </div>     <div data-theme='a' data-role='footer' data-position='fixed' data-tap-toggle='false'>         <a class='botonprev' data-role='button' data-transition='none' href='#vicious1' data-icon='arrow-l'>     <%= dic_prev %>    </a>    <a class='botonnext' data-role='button' data-transition='none' href='#vicious3' data-icon='arrow-r' data-iconpos='right'>     <%= dic_next %>    </a>     </div>";
				vicious3 = "<div data-role='content'>    <div class='hojacuaderno'>       <div class='headerhojacuaderno transfer' data-role='header'>        <h2>          <%= dic_vicious_header %>        </h2>       </div> 	  <div data-role='content'>     <canvas id='myCanvas'></canvas> 	<div id='auxcanvas'></div> 	<a id='shareb' class='colorverde' data-role='button' data-transition='none'> 		 <img src='img/shareandroid.png' width='40' height='40'> <br/>       <%= dic_share %>        </a>    </div>    </div>    </div>     <div data-controltype='htmlblock'>      <div data-theme='a' data-role='footer' data-position='fixed' data-tap-toggle='false'>         <a class='botonprev modify' data-role='button' data-transition='none' href='#vicious2' data-icon='arrow-l'>      <%= dic_prev %>    </a> 		<a class='botonnext finishtool' data-role='button' data-transition='none' rel='external' data-icon='check' data-iconpos='right'>      <%= dic_finish %>    </a>     </div>     </div>";
				vicioushistory = "	<div data-role='content'>    <div class='hojacuaderno viciouspage'>       <div class='headerhojacuaderno transfer' data-role='header'>        <h2>         <%= dic_vicious_header %>        </h2>       </div>    <div data-role='content'>    <div class='vicioushistory'>    <img src='<%= uriShare %>' width='40' height='40'>    </div>    <a id='shareb' class='colorverde' data-role='button' data-transition='none'> 		 <img src='img/shareandroid.png' width='40' height='40'> <br/>       <%= dic_share %>        </a>    </div>   </div>   </div>    <div data-theme='a' data-role='footer' data-position='fixed' data-tap-toggle='false'>         <a class='botonstart' data-role='button' data-transition='none' href='#summary'>     <%= dic_back %>    </a>     </div>";
				headerandpanel = "<div id='menuheader' data-theme='a' class='menuheader' data-role='header' data-position='fixed' data-tap-toggle='false'>     <a id='menubutton' class='panelbutton dic_menu' data-controltype='panelbutton' data-role='button' href='#panelhoffman' data-icon='menuicon'> 	 <%= dic_menu %>     </a>     <div style=' text-align:center' data-controltype='image'>      <img class='logohoffman' src='img/logo_hoffman.png' />     </div>     <a class='panelbutton dic_help' data-controltype='panelbutton' data-role='button' data-theme='a' href='#panelayuda' data-icon='helpicon' data-iconpos='right'>      <%= dic_help %>     </a>    </div>    <div data-role='panel' id='panelhoffman' data-position='left' data-display='overlay'     data-theme='a'>         <ul data-role='listview' id='listapanel' data-divider-theme='h' data-inset='false'>             <li data-theme='c' data-role='list-divider' role='heading' class='hoffmanseparator midgray'>                <div class='pruebaheight' style=' text-align:center' data-controltype='image'> 				 <img id='panelhoffmanlogo' class='logohoffman' src='img/logo_hoffman.png' /> 				</div>             </li> 			<li data-theme='c' class='grisclaro'>                 <a href='#summary' class='summary toolbutton firstbutton'> 					<%= dic_summary_header %>                 </a>             </li> 			<li data-theme='c' data-role='list-divider' role='heading' class='midgray primermyaccountandsettingsseparator toolbutton'> 					<%= dic_panel_tools %>             </li>             <li data-theme='c' class='grisclaro'>                 <a href='#quadSelection' class='quad toolbutton'> 					<%= dic_quad_header %>                 </a>             </li>             <li data-theme='c' class='grisclaro'>                 <a href='#feeling0' class='feeling toolbutton'>                     <%= dic_feeling_header %>                 </a>             </li>             <li data-theme='c' class='grisclaro'>                 <a href='#bashDisc' class='bashacker toolbutton'>                     <%= dic_bash_header %>                 </a>             </li>             <li data-theme='c' class='grisclaro' style='display:none'>                 <a href='#pattern0' class='patternr toolbutton'>                     <%= dic_pattern_header %>                 </a>             </li> 			<li data-theme='c' class='grisclaro'>                 <a href='#beatyourdark0' class='beatyour toolbutton'>                     <%= dic_beatyour_header %>                 </a>             </li> 			<li data-theme='c' class='grisclaro'>                 <a href='#vicious0' class='vicious toolbutton'>                     <%= dic_vicious_header %>                 </a>             </li>             <li data-theme='c' class='grisclaro'>                 <a href='#transSelection' class='transfer toolbutton'>                     <%= dic_transf_header %>                 </a>             </li> 			<li data-theme='c' class='grisclaro'>                 <a href='#visionboard0' class='visionboard toolbutton'>                     <%= dic_vision_header %>                 </a>             </li> 			<li data-theme='c' class='grisclaro'>                 <a id='journal' href='#journal0' class='history toolbutton'>                 <%= dic_journal_header %>                 </a>             </li>             <li data-theme='c' data-role='list-divider' role='heading' class='midgray myaccountandsettingsseparator toolbutton multi'>                 <%= dic_panel_multimedia  %>             </li> 			<li data-theme='c' class='grisclaro'>                 <a href='#recycling0' class='recycling toolbutton'>                 <%= dic_recycling_header  %>                 </a>             </li>             <li data-theme='c' class='grisclaro'>                 <a href='#meditations0' class='meditations toolbutton'>                  <%= dic_meditations_header  %>                 </a>             </li> 			<li data-theme='c' data-role='list-divider' role='heading' class='midgray myaccountandsettingsseparator toolbutton acc'>                 <%= dic_panel_account  %>             </li>             <li data-theme='c' class='grisclaro'>                 <a href='#historyload' class='history toolbutton'>                 <%= dic_history_header %>                 </a>             </li>             <li data-theme='c' data-role='list-divider' role='heading' class='midgray myaccountandsettingsseparator toolbutton sett'>                 <%= dic_panel_settings  %>             </li>                         <li data-theme='c' class='grisclaro'>                 <a href='#configuration' class='configuration toolbutton'>                 <%= dic_config_header %>                 </a>             </li>         </ul>     </div> 	<div data-role='panel' id='panelayuda' data-position='right' data-display='overlay'     data-theme='a'>         <ul data-role='listview' id='listapanel' data-divider-theme='h' data-inset='false'>             <li data-theme='c' data-role='list-divider' role='heading' class='midgray helpheader'>                 <%= dic_rightpanel_header  %>             </li> 			<div class='helpblock' data-role='content' data-controltype='textblock' style='color:white'> 			<%= helppanel %> 			</div>         </ul>     </div>";
