...
define([
  ...
  'text!../Templates/historyelement.html',
  'jquerymobile'
  ...
  historyElementView = Backbone.View.extend({
	...
	this.$el.empty().append("<p class='fechasummarytools'>"+this.model.get("date")+"</p><a data-transition='none' class='toolbutton'></a><a data-icon='delete' class='ui-icon-alt deleteEntry colIndex='"+index+"' elementosfinos' data-rel='dialog'' data-transition='none'>Delete</a>");
